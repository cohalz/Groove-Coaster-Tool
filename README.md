...
## グルコスマップ
https://drive.google.com/open?id=134HcDbw5dfxJbhbPR8FJcHAtKRM&usp=sharing

[GASを使ってグルーヴコースター設置店舗マップを半自動で取得・更新できる仕組みを作った](https://cohalz.hatenablog.com/entry/2018/04/02/195934) を参照
